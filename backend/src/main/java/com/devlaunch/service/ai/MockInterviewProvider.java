 ...
 * {@link InterviewType} (optionally filtered by {@link InterviewDifficulty}
 * and limited to a requested count) and evaluate the user's answers,
 * returning a structured {@link MockInterviewFeedback}. The service layer
 * selects a provider based on {@link #isConfigured()}, preferring a real
 * LLM provider (e.g. OpenAI) when configured and falling back to a
...
public interface MockInterviewProvider {
     ...
     * difficulty mode, and requested length.
     *
